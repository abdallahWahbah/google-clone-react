...
const Results = () => {
  const {getResults, results, isLoading, setSearchTerm, searchTerm} = useResultContext();

  const location = useLocation(); // /vidoes, /images, /search (the string after the first forward slash)
